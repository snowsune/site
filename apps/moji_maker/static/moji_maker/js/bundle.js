var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	return {
    		c() {
    			...
    			t = space();
    			input = element("input");
    			attr(canvas_1, "width", "256");
    			attr(canvas_1, "height", "256");
    		...
    		m(target, anchor) {
    			...
    			set_input_value(input, /*colors*/ ctx[1].primary);

    			if (!mounted) {
    				dispose = [
    					listen(input, "input", /*input_input_handler*/ ctx[4]),
    					listen(input, "change", /*update*/ ctx[2])
    				];
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	function input_input_handler() {
    		colors.primary = this.value;
    		$$invalidate(1, colors);
    	}

    	return [canvas, colors, update, canvas_1_binding, input_input_handler];
    }
    ...
    const app = new App({
    	target: document.getElementById('moji-maker-app'),
    });
